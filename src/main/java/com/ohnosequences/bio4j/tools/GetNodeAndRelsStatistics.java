...
import com.ohnosequences.bio4j.neo4j.model.nodes.AlternativeProductNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.CityNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.CommentTypeNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.ConsortiumNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.CountryNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.EnzymeNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.FeatureTypeNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.GoTermNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.InstituteNode;
...
import com.ohnosequences.bio4j.neo4j.model.nodes.KeywordNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.OrganismNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.PersonNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.PfamNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.ProteinNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.SequenceCautionNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.SubcellularLocationNode;
...
import com.ohnosequences.bio4j.neo4j.model.nodes.citation.DBNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.citation.JournalNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.citation.OnlineArticleNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.citation.OnlineJournalNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.citation.PatentNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.citation.PublisherNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.citation.SubmissionNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.citation.ThesisNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.citation.UnpublishedObservationNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.ncbi.NCBITaxonNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.reactome.ReactomeTermNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.refseq.CDSNode;
import com.ohnosequences.bio4j.neo4j.model.nodes.refseq.GeneNode;
...
import com.ohnosequences.bio4j.neo4j.model.nodes.refseq.rna.MiscRNANode;
import com.ohnosequences.bio4j.neo4j.model.nodes.refseq.rna.NcRNANode;
import com.ohnosequences.bio4j.neo4j.model.nodes.refseq.rna.RRNANode;
